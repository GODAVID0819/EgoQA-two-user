...
def load_frozen_score_only_reviewer(
    ...
    *,
    ...
    config = ReviewerV1Config(
        ...
        model_name_or_path=str(contract["model_name_or_path"]),
        evidence_loss_weight=float(contract["evidence_loss_weight"]),
        answerability_loss_weight=float(contract["answerability_loss_weight"]),
        formality_loss_weight=float(contract["formality_loss_weight"]),
        train_evidence_count=int(contract["train_evidence_count"]),
        validation_evidence_count=int(contract["validation_evidence_count"]),
        locked_test_evidence_count=int(contract["locked_test_evidence_count"]),
    ...
    backbone, _ = inject_reviewer_lora(backbone, config)
    reviewer = ReviewerV1(
