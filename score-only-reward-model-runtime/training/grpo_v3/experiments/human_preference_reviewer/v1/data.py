...
def validate_split_manifest(
    ...
    *,
    ...
    if require_contract:
        ...
        if manifest.get("ordinal_target_mapping") != ORDINAL_TARGET_MAPPING:
            raise ValueError("split manifest ordinal_target_mapping mismatch")
...
def build_split_manifest(
    ...
    *,
    ...
    manifest = {
        ...
        "selection_strategy": "deterministic_seeded_full_support_search",
        "seed": seed,
