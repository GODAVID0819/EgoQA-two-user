...
class SixUserTorchJobContractTests(unittest.TestCase):
    ...
    def assert_common_contract(self, text: str) -> None:
        ...
        self.assertIn("speaker_all_clustering_frames_five_provider_retained_cluster_frames", text)
        ...
        self.assertIn("def model_call_count(row):", text)
        self.assertIn('"generator_call_count": generator_call_count', text)
        self.assertIn('"groundedness_call_count": groundedness_call_count', text)
        ...
        self.assertIn('by_groundedness_identity = prompt_rows_by_generation_identity(', text)
        self.assertNotIn('by_segment_identity = prompt_rows_by_generation_identity(', text)
        self.assertNotIn('by_aggregation_identity = prompt_rows_by_generation_identity(', text)
        ...
        self.assertIn('accepted QA must have exactly 1 simple evidence groundedness call', text)
        self.assertNotIn('accepted QA must have 6 evidence segment observations', text)
        self.assertNotIn('accepted QA must have 1 evidence aggregation', text)
        self.assertIn('"groundedness_video_count": 6', text)
        self.assertIn('"evidence_segment_observation_count": 0', text)
        self.assertIn('"evidence_groundedness_aggregation_count": 0', text)
        ...
        self.assertIn("six_user_media_preflight_passed", text)
        self.assertIn(
        ...
        video_preflight = text.index("six_user_media_preflight_passed")
