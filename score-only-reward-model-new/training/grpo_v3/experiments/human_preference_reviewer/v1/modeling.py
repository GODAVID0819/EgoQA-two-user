"""Independent two-logit binary classification heads for Reviewer v2."""
...
if nn is not None:
    class BinaryHead(nn.Module):
        """Two class logits ordered as [fail, pass]."""
    ...
    class ReviewerV1(nn.Module):
        """Wrap Qwen3-VL with independent fail/pass classification heads."""
        ...
        def __init__(
            ...
            for module_name in head_module_names(self.active_heads):
                setattr(self, module_name, BinaryHead(hidden_size))
        ...
        def forward(self, **inputs: Any) -> ReviewerOutput:
            ...
            head_input = pooled.to(dtype=first_head.classifier.weight.dtype)
    ...
    class BinaryHead:  # type: ignore[no-redef]
        def __init__(self, *_: Any, **__: Any) -> None:
            raise RuntimeError("PyTorch is required to construct BinaryHead")
